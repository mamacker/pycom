...
pinInput = machine.Pin(23, machine.Pin.IN, machine.Pin.PULL_UP)
...
while True:
    if utime.ticks_ms() - last_server_check > 5000:
        ...
        print ("Calling the amackers.com");
        res = retrieve_url('https://theamackers.com/boom/get?which=' + str(val))
    ...
    if pinInput.value() == 0:
        if caller_pinged:
            ...
            retrieve_url('https://theamackers.com/boom/clear?which=' + str(val))
            caller_pinged = False
            clear_lights();
        else:
            ...
            blink_on = True
            last_blink = utime.ticks_ms()
            retrieve_url('https://theamackers.com/boom/set?which=' + str(val))
            caller_pinged = True
